...
//main fiber function
static thread_local saber::Fiber* t_fiber=nullptr;
namespace saber{
/************************************************************************
 *Class Scheduler
 ************************************************************************/
    ...
    if(use_caller){
        ...
        saber::Thread::SetName(m_name);

        t_fiber=m_rootFiber.get();
        m_rootThread=saber::GetThreadId();
    ...
    while(true){
        ...
        bool tickle_me=false;
        {
            ...
            while(it!=m_fibers.end()){
                if(it->thread!=-1&&it->thread!=saber::GetThreadId()){
                    ++it;
                    tickle_me=true;
                    continue;
                }
